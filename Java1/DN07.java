...
public class DN07 {
    public static void main(String[] args) {
        ...
        for(int i = 0; i < N; i++){
            ...
            //nakljucne kordinate in velikost
            double  n = rand.nextDouble();
            //double  x1 = rand.nextInt(SIRINA) + 0;
            //double  y1 = rand.nextInt(VISINA) + 0;
            ...
            narisi(x1,y1,clr,n+0.01);
        }
    }
    private static void narisi(double x, double y, Color c, double v) {
        double zamik = v * 0.25;
